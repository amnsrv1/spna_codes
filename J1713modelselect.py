...
model2 = wn + tm
model3 = ef + arn + tm
model4 = ef + arn + dmn + tm
model5 = ef + arn + dmn + scn + tm 
...
# ## PRIOR TRANSFORM, NESTLE AND DYNESTY
...
'''
Nres6 = nestle_sample(pta6)
print('for model 6 evidence is ',Nres6.logz, '+/-',Nres6.logzerr)
...
fig4 = corner.corner(samples_nestle4,labels=list(pta4.param_names), label_kwargs={"fontsize": 7},
                     quantiles=(0.16, 0.5, 0.84),show_titles=False)
plt.suptitle("J1713+0747", fontsize=16)
plt.savefig('J1713_model4.pdf')


samples_nestle5 = nestle.resample_equal(Nres5.samples, Nres5.weights)
fig5 = corner.corner(samples_nestle5,labels=list(pta5.param_names), label_kwargs={"fontsize": 7},
                     quantiles=(0.16, 0.5, 0.84),show_titles=False)
plt.suptitle("J1713+0747", fontsize=16)
plt.savefig('J1713_model5.pdf')
...
samples_nestle6 = nestle.resample_equal(Nres6.samples, Nres6.weights)
fig6 = corner.corner(samples_nestle6,labels=list(pta6.param_names), label_kwargs={"fontsize": 7},
                     quantiles=(0.16, 0.5, 0.84),show_titles=False)
plt.suptitle("J1713+0747", fontsize=16)
plt.savefig('J1713_model6.pdf')
