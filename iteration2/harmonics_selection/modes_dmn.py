...
f= open("modes_dmn_"+psrname+".txt","w+")
...
for i in dm:
        ...
        dmn = dm_noise_block(gp_kernel='diag', psd='powerlaw', nondiag_kernel='periodic',prior='log-uniform',
         	dt=15,df=200,Tspan=Tspan_chrom, components=i,gamma_val=None, coefficients=False)
        ...
        print(" For dmn model with dmn modes as",i,", the log evidence is = {} ± {}".format(Dres.logz[-1], Dres.logzerr[-1]), file=f)
